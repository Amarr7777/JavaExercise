...
public class Main {
    ...
    private static final String JDBC_URL = "jdbc:postgresql://localhost:5432/jdbc_java";
    ...
    private void placeComponents(JPanel panel) {
        ...
        accountNumberLabel.setBounds(10, 60, 150, 25);
        panel.add(accountNumberLabel);

        JTextField accountNumberText = new JTextField(20);
        accountNumberText.setBounds(160, 60, 100, 25);
        ...
        balanceText.setBounds(100, 100, 165, 25);
